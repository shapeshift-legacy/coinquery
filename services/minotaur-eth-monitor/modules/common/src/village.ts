...
import { CommonConfig, VillageDatabaseConfig } from './types'
...
export async function createVillage<Model, Config extends CommonConfig>(
  schema: any,
  config: Config
): Promise<MinotaurVillage<Model, Config>> {
  return {
    config,
