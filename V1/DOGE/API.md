# CoinQuery Dogecoin API

1) CoinQuery host:
`{ROOT} = https://doge.redacted.example.com/`


Content below copied from [https://github.com/blockrange/insight-api-dogecoin](https://github.com/blockrange/insight-api-dogecoin/blob/master/README.md) with minor modifications for formatting

Some examples use Bitcoin addresses and txids. Please substitute appropriate Dogecoin adress

----------------------------

Insight API is an open-source blockchain REST and websocket API. Insight API runs in NodeJS and uses LevelDB for storage.  insight provides a REST API at `/api`
